		...
		public function request()
		{
			...
			if (false === $remote || !$this->cache_allowed) {
				...
				$remote = wp_remote_get(
					'https://raw.githubusercontent.com/LTH-Plugins/lth-core/main/info.json?token=GHSAT0AAAAAAB43CY6FSJL3WQG5H54M4PI2Y5M54SA', // đường dẫn đến thư mục chứa file plugin, json
					array(
						'timeout' => 10,
						'headers' => array(
